...
public class UberAdapter implements VendorAdapter {
    ...
    public List<VendorSearchResult> search(VendorSearchRequest request) {
        ...
        uberGo.setPrice(com.omnibot.adapter.util.DynamicDataGenerator.applySurge(BigDecimal.valueOf(random.nextInt(70, 151))));
        uberGo.setCurrency("INR");
        uberGo.setEtaMinutes(com.omnibot.adapter.util.DynamicDataGenerator.calculateDynamicEta(3, 11));
        uberGo.setEtaLabel(uberGo.getEtaMinutes() + " mins away");
        ...
        uberPremier.setPrice(com.omnibot.adapter.util.DynamicDataGenerator.applySurge(BigDecimal.valueOf(random.nextInt(120, 251))));
        uberPremier.setCurrency("INR");
        uberPremier.setEtaMinutes(com.omnibot.adapter.util.DynamicDataGenerator.calculateDynamicEta(5, 13));
        uberPremier.setEtaLabel(uberPremier.getEtaMinutes() + " mins away");
        ...
        uberAuto.setPrice(com.omnibot.adapter.util.DynamicDataGenerator.applySurge(BigDecimal.valueOf(random.nextInt(30, 81))));
        uberAuto.setCurrency("INR");
        uberAuto.setEtaMinutes(com.omnibot.adapter.util.DynamicDataGenerator.calculateDynamicEta(2, 7));
        uberAuto.setEtaLabel(uberAuto.getEtaMinutes() + " mins away");
        ...
        uberMoto.setPrice(com.omnibot.adapter.util.DynamicDataGenerator.applySurge(BigDecimal.valueOf(random.nextInt(20, 51))));
        uberMoto.setCurrency("INR");
        uberMoto.setEtaMinutes(com.omnibot.adapter.util.DynamicDataGenerator.calculateDynamicEta(1, 5));
        uberMoto.setEtaLabel(uberMoto.getEtaMinutes() + " mins away");
